...
if(processor_num == 0){
	if (currentStats.core0.curr_signal == P_RD){
		if ((currentStats.core0.prev_status == Modified) || (currentStats.core0.prev_status == Shared)){
		...
		if (currentStats.core0.prev_status == Modified){
			currentStats.core0.new_status = Shared;
		}
		else if ((currentStats.core0.prev_status == Invalid) || (currentStats.core0.prev_status == Uninit) || currentStats.core0.prev_status == Shared ){
			currentStats.core0.new_status = currentStats.core0.prev_status;
		}
	}
	...
	if (currentStats.core1.curr_signal == P_RD){
		if ((currentStats.core1.prev_status == Modified) || (currentStats.core1.prev_status == Shared)){
		...
		if (currentStats.core1.prev_status == Modified){
			currentStats.core1.new_status = Shared;
		}
		else if ((currentStats.core1.prev_status == Invalid) || (currentStats.core1.prev_status == Uninit) || currentStats.core1.prev_status == Shared ){
			currentStats.core1.new_status = currentStats.core1.prev_status;
		}
	}
	...
	if (currentStats.core2.curr_signal == P_RD){
		if ((currentStats.core2.prev_status == Modified) || (currentStats.core2.prev_status == Shared)){
		...
		if (currentStats.core2.prev_status == Modified){
			currentStats.core2.new_status = Shared;
		}
		else if ((currentStats.core2.prev_status == Invalid) || (currentStats.core2.prev_status == Uninit) || currentStats.core2.prev_status == Shared ){
			currentStats.core2.new_status = currentStats.core2.prev_status;
		}
	}
	...
	if (currentStats.core3.curr_signal == P_RD){
		if ((currentStats.core3.prev_status == Modified) || (currentStats.core3.prev_status == Shared)){
		...
		if (currentStats.core3.prev_status == Modified){
			currentStats.core3.new_status = Shared;
		}
		else if ((currentStats.core3.prev_status == Invalid) || (currentStats.core3.prev_status == Uninit) || currentStats.core3.prev_status == Shared ){
			currentStats.core3.new_status = currentStats.core3.prev_status;
		}
	}
